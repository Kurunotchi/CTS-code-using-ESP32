...
const unsigned long wifiDataInterval = 5000;  
...
void sendSensorDataOverTCP(char slot) {
    ...
    if (millis() - lastTCPSend < 2000) return;  
...
void calculateCapacity(char slot, float current, unsigned long currentTime) {
  ...
  if (!isActive && *tracking) {
    ...
    *lastTime = 0;
    Serial.print("Slot "); Serial.print(slot); 
    Serial.print(" Tracking ended. Total: "); Serial.print(*capacity, 4); Serial.println(" mAh");
  }
  
  if (*tracking && *lastTime > 0 && currentTime > *lastTime) {
    float dt = (currentTime - *lastTime) / 3600000.0;  
    ...
    case 'A': {
      if (Acharge && voltageA >= CHARGE_STOP_V) {
        ...
        if (Acycle && battNumA > 0) {
          ...
          Serial.print("Slot A charge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
      ...
      if (Adischarge && voltageA <= DISCHARGE_STOP_V) {
        ...
        if (Acycle && battNumA > 0) {
          ...
          Serial.print("Slot A discharge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
    ...
    case 'B': {
      if (Bcharge && voltageB >= CHARGE_STOP_V) {
        ...
        if (Bcycle && battNumB > 0) {
          ...
          Serial.print("Slot B charge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
      ...
      if (Bdischarge && voltageB <= DISCHARGE_STOP_V) {
        ...
        if (Bcycle && battNumB > 0) {
          ...
          Serial.print("Slot B discharge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
    ...
    case 'C': {
      if (Ccharge && voltageC >= CHARGE_STOP_V) {
        ...
        if (Ccycle && battNumC > 0) {
          ...
          Serial.print("Slot C charge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
      ...
      if (Cdischarge && voltageC <= DISCHARGE_STOP_V) {
        ...
        if (Ccycle && battNumC > 0) {
          ...
          Serial.print("Slot C discharge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
    ...
    case 'D': {
      if (Dcharge && voltageD >= CHARGE_STOP_V) {
        ...
        if (Dcycle && battNumD > 0) {
          ...
          Serial.print("Slot D charge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
      ...
      if (Ddischarge && voltageD <= DISCHARGE_STOP_V) {
        ...
        if (Dcycle && battNumD > 0) {
          ...
          Serial.print("Slot D discharge complete - Capacity: "); Serial.print(storedCapacity, 4); Serial.println(" mAh");
...
void logSimpsonWithCapacity(char slot, float capacity) {
    ...
    dtostrf(capacity, 10, 4, capacityStr);  // Changed to 4 decimal places
    ...
    Serial.print(" with capacity: "); Serial.print(capacity, 4); Serial.println(" mAh");
                    ...
                    const char* operationMode)
{
    ...
    dtostrf(capacity, 10, 4, capacityStr);  //4 decimal places
